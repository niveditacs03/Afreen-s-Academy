...
const Card = ({ image, title, content }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300 p-5 w-72 h-[350px] flex-shrink-0 shadow:md">
      <img src={image} alt="Card Image" className="w-full h-40 object-cover rounded-t-2xl" />
      ...
      <div 
        ...
        {isOpen ? (
          <button className="bg-teal-500 text-white w-11 h-11 flex items-center justify-center rounded-full shadow-md hover:bg-teal-600 transition"
